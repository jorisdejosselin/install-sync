...
class GlobalConfig(BaseModel):
    ...
    git_auto_commit: Optional[bool] = Field(None, description="Auto-commit package changes")
    git_auto_push: Optional[bool] = Field(None, description="Auto-push package changes") 
    git_prompt: bool = Field(True, description="Prompt before git operations")
    default_tracking_directory: Optional[str] = Field(None, description="Default tracking directory")
    package_managers: Dict[str, str] = Field(default_factory=dict, description="Package manager preferences per OS")
...
class RepoConfig(BaseModel):
    ...
    tracking_directory: Optional[str] = Field(None, description="Local tracking directory path")
